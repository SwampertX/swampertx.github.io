...
|                                           |                                        |
| ----------------------------------------- | -------------------------------------- |
| [![Github][view-on-gh-badge]][stepper-gh] | [![Source Academy][sa-badge]][sa-link] |

[![Source Stepper in Action: Factorial(10)](/media/stepper.gif)](/media/stepper.gif)
[Try out the substituter!](sa-link)

A lambda-calculus based interpreter for the [Source language](https://sicp.comp.nus.edu.sg/source/), a sublanguage of JavaScript, written in TypeScript.

This interpreter steps through and records each reduction step of the program. It can be used for the first 2 chapters of the source language ([Source §1](https://sicp.comp.nus.edu.sg/source/source_1/), [Source §2](https://sicp.comp.nus.edu.sg/source/source_2/)) as state changes are not allowed in these languages. Idempotency of pure functions ensures the lambda-calculus based reduction rules evaluate the program correctly.
...
|                                            |                                                   |
| ------------------------------------------ | ------------------------------------------------- |
| [![Github][view-on-gh-badge]][cinnabot-gh] | [![Telegram][cinnabot-tele-badge]][cinnabot-tele] |
...
IVLE has been replaced by [LumiNUS](https://luminus.nus.edu.sg) since Aug 2019. For a LumiNUS downloader, please check out
